...
public:
    ...
    rstd::uint32_t Width() const override { return extent_.width; }
    rstd::uint32_t Height() const override { return extent_.height; }
...
private:
    ...
    bool EnsureCpuStaging(rstd::size_t size);
    ...
    rstd::uint32_t FindMemoryType(rstd::uint32_t type_bits, VkMemoryPropertyFlags props) const;
    ...
    Vec<VkImage>                    swap_images_;
    rstd::uint32_t                  frame_index_ { 0 };
    static constexpr rstd::uint32_t kMaxFramesInFlight = 2;
    ...
    Vec<VkSemaphore> render_done_sem_;
